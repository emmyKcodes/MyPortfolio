...
const Links = [
  {
    ...
    link: "/",
    icon: (
      isActive: boolean // Modified to accept isActive prop
    ) => (
      <div
      ...
      >
        <span
          className={`absolute bottom-0 left-0 top-0 z-0 h-full w-0 bg-[#6F4E37] transition-all duration-500 group-hover:w-full ${
            isActive ? "w-full" : ""
          }`}
        />
        <FiHome
              ...
              {Links.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={`text-xs mt-2 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition duration-300 ${
                        isActive
                          ? "text-white"
                          : "text-transparent md:group-hover:text-white"
                      }`}
                    >
                      {item.name}
                    </span>
